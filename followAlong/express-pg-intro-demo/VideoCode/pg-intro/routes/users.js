...
router.get('/', async (req, res, next) => {
  try {
    ...
    // using { users : ...} is good for labeling
...
// You may want to add some logic that can prevent user from getting the msg: "DELETED!" 
// even when an invalid id is passed through. Right now our app doesn't care.
